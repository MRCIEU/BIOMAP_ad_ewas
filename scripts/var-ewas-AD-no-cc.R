...
# Edited by Sarah Watkins, July (onwards) 2024
#
...
pheno_summary_table_outfile_1 <- "[cohort_name]_var-ewas-pheno_summary_numeric_vars_meanSD_no-cc.csv"
pheno_summary_table_outfile_2 <- "[cohort_name]_var-ewas-pheno_summary_numeric_vars_ttest_no-cc.csv"
pheno_summary_table_outfile_3 <- "[cohort_name]_var-ewas-pheno_summary_categorical_vars_counts_no-cc.csv"
out_file <- "[cohort_name]_varewas-res-no-cc.tsv"
